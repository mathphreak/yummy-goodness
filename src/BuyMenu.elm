...
viewSix : (Equipment -> msg) -> List Equipment -> Html msg
viewSix msg inv =
    let
        buildItem i e =
...
viewFour : (Equipment -> msg) -> List Equipment -> Html msg
viewFour msg inv =
    let
        buildItem i e =
            { index = (i + 1), cost = "$" ++ (toString (Equipment.cost e)), name = Equipment.toString e, action = Just (msg e) }
...
viewSubmenu : (Equipment -> msg) -> List Equipment -> Html msg
viewSubmenu msg inv =
...
viewMenu : (Equipment.Submenu -> msg) -> Html msg
viewMenu msg =
    svg [ viewBox "0 0 100 100", width "300px" ]
